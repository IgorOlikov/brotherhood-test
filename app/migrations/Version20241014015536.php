 ...
 */
final class Version20241014015536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT NOT NULL, full_name VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(12) DEFAULT NULL, age INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, name VARCHAR(255) NOT NULL, client VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
