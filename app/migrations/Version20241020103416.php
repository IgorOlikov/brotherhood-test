 ...
 */
final class Version20241020103416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id SERIAL NOT NULL, status VARCHAR(255) NOT NULL, full_name VARCHAR(200) NOT NULL, position VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, phone_number VARCHAR(12) NOT NULL, date_of_brith TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_of_employment TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_of_dismissal TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE project (id SERIAL NOT NULL, name VARCHAR(200) NOT NULL, client VARCHAR(255) NOT NULL, status VARCHAR(20) NOT NULL, slug VARCHAR(255) NOT NULL, opened_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, closed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
